            ...
            <div class="wapper">
                ...
                <div class="center">
                    ...
                    <form name="formMain">
                        <div class="msg">
                            <div class="msg_chat">
                                <div class="result1" id="result1">Chào mừng bạn đến với game cờ tướng. Chúc vui vẻ!</div>
                                <div class="result" id="result2"></div>
                                <div class="result" id="result3"></div>
                            </div>
                            <div class="msg_send">
                                <div class="msg_send_text"><input type="text" onkeydown="enter(event)" onscroll=""autocomplete="off" name="msg"></div>
                                <div class="msg_send_button"><input onclick='getChat("chat.jsp")' type="button" name="send" value="Gửi"></div>
                            </div>
                        </div>
                    </form>
                </div>
